...
const MyProjects = () => {
    return ( 
        <section className="myProjects main__section" data-id="4">
            ...
            <div className="myProjects__SAOClicker">
                ...
                <a href="https://www.youtube.com/watch?v=dchkT0uUfhs" target="_blank" rel="noreferer" className="myProjects__link"><Button className="button myProjects__button">Zobacz Trailer!</Button></a>
                <a href="http://www.clicker.questionmarksanime.pl" target="_blank" rel="noreferer" className="myProjects__link"><Button className="button myProjects__button">Zagraj!</Button></a>
            </div>
            <div className="myProjects__QMA">
                ...
                <a href="http://questionmarksanime.pl" target="_blank" rel="noreferer" className="myProjects__link"><Button className="button myProjects__button">Odwiedź Stronę!</Button></a>
            </div>
        </section>
     );
}
