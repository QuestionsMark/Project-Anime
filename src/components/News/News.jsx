        ...
        <Switch>
            <Route path="/news" exact>
                <div className="news main__content scrollNav" data-id="4">
                    ...
                    {status ? <Popup modal nested closeOnDocumentClick={false} trigger={<div className="news__add"><AddRounded className="news__add-new-news"/> Dodaj Nowość</div>} on="click">
